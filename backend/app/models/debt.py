...
class DebtInstrument(Base):
    ...
    instrument_type: Mapped[InstrumentType] = mapped_column(Enum(InstrumentType, name="instrument_type"), nullable=False)
    ...
    amortization_type: Mapped[AmortizationType] = mapped_column(Enum(AmortizationType, name="amortization_type"), nullable=False)
